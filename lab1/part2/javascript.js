...
map.on('click', 'libraries', function(f) {
  ...
  popup.setLngLat(refLibrary.geometry.coordinates)
    .setHTML('<b>' + refLibrary.properties.NAME + '</b><br>The nearest hospital is ' + nearestHospital.properties.NAME + ', located at ' + nearestHospital.properties.ADDRESS + '.<br>It is ' + distance.toFixed(2) + ' miles away.')
    .addTo(map);
});
